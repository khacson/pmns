...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    /**
     * Invalid friendlyURL in sheet title
     *
     * @var array
     */
   ...
   /**
    ...
    /**
     * Get array of invalid friendlyURL for sheet title
     *
     * @return array
     */
    ...
    {
        // Some of the printable ASCII friendlyURL are invalid:  * : / \ ? [ ]
        if (str_replace(self::$_invalidCharacters, '', $pValue) !== $pValue) {
            throw new PHPExcel_Exception('Invalid character found in sheet title');
        }

        // Maximum 31 friendlyURL allowed for sheet title
        if (PHPExcel_Shared_String::CountCharacters($pValue) > 31) {
            throw new PHPExcel_Exception('Maximum 31 friendlyURL allowed in sheet title.');
        }
