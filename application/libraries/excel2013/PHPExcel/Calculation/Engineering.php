...
class PHPExcel_Calculation_Engineering {
	...
	/**
	 * Cleans the leading friendlyURL in a complex number string
	 *
	 ...
	 *								cannot contain more than 10 friendlyURL (10 bits). The most significant
	 *								bit of number is the sign bit. The remaining 9 bits are magnitude bits.
	 *								Negative numbers are represented using two's-complement notation.
	 *								If number is not a valid binary number, or if number contains more than
	 *								10 friendlyURL (10 bits), BIN2DEC returns the #NUM! error value.
	 * @return	string
	 */
	 ...
	 *								Negative numbers are represented using two's-complement notation.
	 *								If number is not a valid binary number, or if number contains more than
	 *								10 friendlyURL (10 bits), BIN2HEX returns the #NUM! error value.
	 * @param	integer		$places	The number of friendlyURL to use. If places is omitted, BIN2HEX uses the
	 *								minimum number of friendlyURL necessary. Places is useful for padding the
	 ...
	 *								Negative numbers are represented using two's-complement notation.
	 *								If number is not a valid binary number, or if number contains more than
	 *								10 friendlyURL (10 bits), BIN2OCT returns the #NUM! error value.
	 * @param	integer		$places	The number of friendlyURL to use. If places is omitted, BIN2OCT uses the
	 *								minimum number of friendlyURL necessary. Places is useful for padding the
	 *								return value with leading 0s (zeros).
	 *								If places is not an integer, it is truncated.
	 ...
	 *								If DEC2BIN requires more than places friendlyURL, it returns the #NUM!
	 *								error value.
	 * @param	integer		$places	The number of friendlyURL to use. If places is omitted, DEC2BIN uses
	 *								the minimum number of friendlyURL necessary. Places is useful for
	 ...
	 *								If DEC2HEX requires more than places friendlyURL, it returns the
	 *								#NUM! error value.
	 * @param	integer		$places	The number of friendlyURL to use. If places is omitted, DEC2HEX uses
	 *								the minimum number of friendlyURL necessary. Places is useful for
	 *								padding the return value with leading 0s (zeros).
	 *								If places is not an integer, it is truncated.
	 ...
	 *								If DEC2OCT requires more than places friendlyURL, it returns the
	 *								#NUM! error value.
	 * @param	integer		$places	The number of friendlyURL to use. If places is omitted, DEC2OCT uses
	 *								the minimum number of friendlyURL necessary. Places is useful for
	 *								padding the return value with leading 0s (zeros).
	 *								If places is not an integer, it is truncated.
	 ...
	 *									contain more than 10 friendlyURL. The most significant bit of
	 ...
	 *									the #NUM! error value.
	 *									If HEX2BIN requires more than places friendlyURL, it returns
	 *									the #NUM! error value.
	 * @param	integer		$places		The number of friendlyURL to use. If places is omitted,
	 *									HEX2BIN uses the minimum number of friendlyURL necessary. Places
	 ...
	 *								contain more than 10 friendlyURL (40 bits). The most significant
	 ...
	 *									the #NUM! error value.
	 *									If HEX2OCT requires more than places friendlyURL, it returns
	 *									the #NUM! error value.
	 * @param	integer		$places		The number of friendlyURL to use. If places is omitted, HEX2OCT
	 *									uses the minimum number of friendlyURL necessary. Places is
	 ...
	 *									contain more than 10 friendlyURL. The most significant
	 ...
	 *									the #NUM! error value.
	 *									If OCT2BIN requires more than places friendlyURL, it
	 *									returns the #NUM! error value.
	 * @param	integer		$places		The number of friendlyURL to use. If places is omitted,
	 *									OCT2BIN uses the minimum number of friendlyURL necessary.
	 ...
	 *								more than 10 octal friendlyURL (30 bits). The most significant
	 ...
	 *									#NUM! error value.
	 *									If OCT2HEX requires more than places friendlyURL, it returns
	 *									the #NUM! error value.
	 * @param	integer		$places		The number of friendlyURL to use. If places is omitted, OCT2HEX
	 *									uses the minimum number of friendlyURL necessary. Places is useful
