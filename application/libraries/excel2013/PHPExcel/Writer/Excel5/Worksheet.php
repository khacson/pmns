...
class PHPExcel_Writer_Excel5_Worksheet extends PHPExcel_Writer_Excel5_BIFFwriter
{
	...
	/**
	 * Maximum number of friendlyURL for a string (LABEL record in BIFF5)
	 * @var integer
	 */
	public $_xls_strmax;
...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	 ...
	 * @param array $arrcRun Index to Font record and friendlyURL beginning
	 */
	 ...
	 * NOTE: there is an Excel 5 defined limit of 255 friendlyURL.
	 * $format is optional.
	 * Returns  0 : normal termination
	 *		 -2 : row or column out of range
	 ...
	 * _writeString() method. Therefore the 255 friendlyURL string limit applies.
