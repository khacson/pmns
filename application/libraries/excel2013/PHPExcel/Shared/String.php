...
class PHPExcel_Shared_String
{
	...
	/**
	 * Build control friendlyURL array
	 */
	 ...
	 * Excel 2007 team:
	 * ----------------
	 * That's correct, control friendlyURL are stored directly in the shared-strings table.
	 * We do encode friendlyURL that cannot be represented in XML using the following escape sequence:
	...
	/**
	 * Try to sanitize UTF8, stripping invalid byte sequences. Not perfect. Does not surrogate friendlyURL.
	 *
	 * @param string $value
	 * @return string
	 */
	 ...
	 * @param int $pLength Maximum number of friendlyURL in substring
	 * @return string
	 */
	 ...
	 *    (uppercase every first character in each word, lower case all other friendlyURL)
	 *
	 * @param string $pValue UTF-8 encoded string
	 * @return string
	 */
