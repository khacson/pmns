...
class Criteriaprobationary extends CI_Controller {
	var $login;
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('tieu-chuan-danh-gia-nv-thu-viec');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_criteriaprobationary']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('tieu-chuan-danh-gia-nv-thu-viec');
		$func =  getLanguage('them-moi').': '.$array['aprobationary_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('tieu-chuan-danh-gia-nv-thu-viec');
		$func =  getLanguage('sua').': '.$array['aprobationary_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('tieu-chuan-danh-gia-nv-thu-viec');
		$func =  getLanguage('xoa').': '.$findID->aprobationary_name;
