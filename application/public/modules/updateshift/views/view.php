			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th id="ord_s.shiftid"><?=getLanguage('ca-lam-viec')?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
			...
			<div id="gridView">
				<table id="group"  width="100%" cellspacing="0" border="1">
					...
					<tr class="row-searach">
						...
						<td>
							<select id='shiftid' name='shiftid' class="combos">
...
<script>
	...
	function init(){
		...
		$('#shiftid').multipleSelect({
			filter: true,
			placeholder:'<?=getLanguage('chon-ca-lam-viec')?>',
			single: false,
			onClick: function(view){
				searchList();
			}
