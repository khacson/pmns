...
foreach ($datas as $key => $item) { 
 ...
 '.getLanguage('cho-duyet').'</a>';
	if($item->approved == 1){
		$approved = '<a id="'.$id.'" href="#" data-toggle="modal" data-target="#myModalFrom" class="btn btn-info edititem" style="padding:0 3px;">'.getLanguage('da-duyet').'</a>';
	}
	elseif($item->approved == 0){
		$approved = '<a id="'.$id.'" href="#" data-toggle="modal" data-target="#myModalFrom" class="btn btn-danger edititem" style="padding:0 3px;">'.getLanguage('khong-duyet').'</a>';
	}
