...
class Insurance extends CI_Controller {
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('bao-hiem-kpcd');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_insurance']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('bao-hiem-kpcd');
		$func =  getLanguage('them-moi').': '.$array['insurance_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('bao-hiem-kpcd');
		$func =  getLanguage('sua').': '.$array['insurance_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('bao-hiem-kpcd');
		$func =  getLanguage('xoa').': '.$findID->insurance_name;
