 ...
 * @copyright 2016
 */
class TimemissionModel extends CI_Model
{
	...
	function getList($search,$page,$rows){
		...
		$sql = "SELECT ts.id, e.code,e.identity , e.fullname, d.departmanet_name, e.departmentid, ts.time_start, ts.time_end, p.position_name, dg.departmentgroup_name, e.group_work_id, e.positionid, ts.description
