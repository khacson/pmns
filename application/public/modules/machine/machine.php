...
class Machine extends CI_Controller {
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('may-cham-cong');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns('hre_machine');
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('may-cham-cong');
		$func =  getLanguage('them-moi').': '.$array['machine_sn'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('may-cham-cong');
		$func =  getLanguage('sua').': '.$array['machine_sn'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('may-cham-cong');
		$func =  getLanguage('xoa').': '.$findID->machine_sn;
