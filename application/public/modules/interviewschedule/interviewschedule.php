...
class Interviewschedule extends CI_Controller {
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('lich-phong-van');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_hre_interviewschedule']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('lich-phong-van');
		$func =  getLanguage('them-moi').': '.$array['fullname'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('lich-phong-van');
		$func =  getLanguage('sua').': '.$array['fullname'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('lich-phong-van');
		$func =  getLanguage('xoa').': '.$findID->fullname;
