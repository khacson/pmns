...
class Ethnic extends CI_Controller {
	var $login;
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_ethnic']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('dan-toc');
		$func =  getLanguage('them-moi').': '.$array['ethnic_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('dan-toc');
		$func =  getLanguage('sua').': '.$array['ethnic_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('dan-toc');
		$func =  getLanguage('xoa').': '.$findID->ethnic_name;
