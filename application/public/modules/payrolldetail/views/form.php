<div class="row">
	...
	<div class="col-md-6 mtop10">
		<div class="form-group">
			...
			<div class="col-md-8">
				<select id="input_isinsurance" name="input_isinsurance" class="select2me form-input form-control " data-placeholder="<?=getLanguage('chon-loai-luong')?>">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<div class="row">
						...
						<div class="col-md-3" style="padding-left:0;"></div>
						<div class="col-md-3" style="padding-left:0;">
							<select id="input_isinsurance_<?=$item->id;?>" name="input_isinsurance_<?=$item->id;?>" class="select2me allowance form-control " data-placeholder="<?=getLanguage('dong-bao-hiem');?>">
								 <option <?php if($typeid == 1){?> selected <?php }?> value="1"><?=getLanguage('co-dong')?></option>
								 <option <?php if($typeid == 0){?> selected <?php }?> value="-1"><?=getLanguage('khong-dong')?></option>
							</select>
						</div>
						<!--<div class="col-md-3" style="padding-left:0;">
