...
class Empcontract extends CI_Controller {
	var $login;
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('qua-han-ky-hop-dong');
	...
	function export(){
		...
		$sheetIndex->setCellValueByColumnAndRow(2, 1, getLanguage('ma-qua-han-ky-hop-dong'));
