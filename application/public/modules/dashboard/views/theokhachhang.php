...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#home">KH mới theo hãng </a></li>
  <li><a data-toggle="tab" href="#menu1">KH mới theo model</a></li>
  <li><a data-toggle="tab" href="#menu2">KH mới dịch vụ</a></li>
  <li><a data-toggle="tab" href="#menu3">KH cũ theo hãng</a></li>
  <li><a data-toggle="tab" href="#menu4">KH cũ theo model</a></li>
  <li><a data-toggle="tab" href="#menu5">KH cũ dịch vụ</a></li>
</ul>
