<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-8">
				...
				value="<?=$finds->distric_name;?>" placeholder=""
				/>
			</div>
		</div>
	</div>
	<div class="col-md-12 mtop10">
		<div class="form-group">
			...
			<div class="col-md-8">
				<select id="input_provinceid" name="input_provinceid" class="form-input select2me form-control" data-placeholder="<?=getLanguage('chon-tinh-thanh-pho')?>">
					<option value=""></option>
