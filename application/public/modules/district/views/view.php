...
<div class="box mtop10">
	<div class="box-header with-border">
	  <div class="brc"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('quan-huyen');?></div>
...
<script>
	...
	function funcList(obj){
		$(".edit").each(function(e){
			$(this).click(function(){ 
				var distric_name = $(".distric_name").eq(e).text().trim();
				var id = $(this).attr('id');
	...
	function refresh(){
		$(".loading").show();
		$(".searchs").val("");
		$('#provinceid').multipleSelect('uncheckAll');
		csrfHash = $('#token').val();
		search = getSearch();
