...
class Holidaysyear extends CI_Controller {
    var $phonedetail;
	var $login;
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('ngay-nghi-nam');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_holidays_year']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-nghi-nam');
		$func =  getLanguage('them-moi').': '.$array['holidays_year_from'].'-'.$array['holidays_year_to'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-nghi-nam');
		$func =  getLanguage('sua').': '.$array['holidays_year_from'].'-'.$array['holidays_year_to'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-nghi-nam');
		$func =  getLanguage('xoa').': '.$findID->holidays_year_from .'-'.$findID->holidays_year_to;
