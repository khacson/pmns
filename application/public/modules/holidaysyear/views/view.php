			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th id="ord_h.description"><?=getLanguage('ghi-chu');?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
			...
			<div id="gridView">
				<table id="group"  width="100%" cellspacing="0" border="1">
					...
					<tr class="row-searach">
						...
						<td></td>
						<td>
							<input type="text" name="holidays_year_from" id="holidays_year_from" class="searchs form-control" />
						</td>
						<td>
							<input type="text" name="holidays_year_to" id="holidays_year_to" class="searchs form-control" required />
						</td>
						<td>
							<input type="text" name="holidays_date" id="holidays_date" class="searchs form-control" required />
						</td>
						<td>
							<input type="text" name="description" id="description" class="searchs form-control" required />
						</td>
						<td></td>
						<td></td>
					</tr>
...
<script>
	...
	function searchFunction(){
		$("#holidays_year_from,#holidays_year_to,#holidays_date,#description").keyup(function() {
			searchList();	
		});
	}
