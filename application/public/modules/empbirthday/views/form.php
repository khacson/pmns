<div class="row">
	...
	<div class="col-md-12 mtop10">
		<div class="form-group">
			<label class="control-label col-md-4" style="padding-left: 5px;"><?=getLanguage('thoi-gian-bat-dau');?>
	...
	<div class="col-md-12 mtop10">
		<div class="form-group">
			<label class="control-label col-md-4" style="padding-left: 5px;"><?=getLanguage('thoi-gian-ket-thuc');?> (<span class="red">*</span>)
			</label>
			<div class="col-md-8">
				<div class="input-group " >
					<div id="datetimepicker2" class="input-append input-group input-process">
