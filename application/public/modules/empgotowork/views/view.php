			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th id="ord_ts.time_start"><?=getLanguage('thoi-gian-vao')?></th>
						<th id="ord_ts.time_end"><?=getLanguage('thoi-gian-ra')?></th>
						<th id="ord_ts.time_start"><?=getLanguage('di-tre')?></th>
						<th id="ord_ts.time_end"><?=getLanguage('ve-som')?></th>
			...
			<div id="gridView">
				<table id="group"  width="100%" cellspacing="0" border="1">
					...
					<tr class="row-searach">
						...
						<td>
							<div  id="click_fromdate" class="input-group date" data-provide="datepicker"  data-date-format="dd/mm/yyyy">
						...
						<td>
							<div  id="click_todate" class="input-group date" data-provide="datepicker"  data-date-format="dd/mm/yyyy">
								<input id="fromdate" name="fromdate" type="text" class="searchs form-control tab-event">
								<div class="input-group-addon">
									<i class="fa fa-calendar "></i>
								</div>
							</div>
...
<script>
	...
	function save(){ 
		...
		if(obj.time_start == ""){
			warning('<?=getLanguage('thoi-gian-vao-khong-duoc-trong');?>'); 
			return false;		
		}
		if(obj.time_end == ""){
			warning('<?=getLanguage('thoi-gian-ra-khong-duoc-trong');?>'); 
			return false;		
		}
		$('.loading').show();
