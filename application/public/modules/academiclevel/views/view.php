...
<div class="box mtop10">
	<div class="box-header with-border">
	  <div class="brc"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('trinh-do-hoc-van');?></div>
			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th id="ord_ac.academic_name"><?=getLanguage('trinh-do-hoc-van');?></th>
						<th id="ord_ac.ordering"><?=getLanguage('thu-tu');?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
			...
			<div id="gridView">
				<table id="group"  width="100%" cellspacing="0" border="1">
					...
					<tr class="row-searach">
						...
						<td></td>
						<td>
							<input type="text" name="academic_name" id="academic_name" class="searchs form-control" />
						</td>
						<td>
...
<script>
	...
	function searchFunction(){
		$("#academic_name,#ordering").keyup(function() {
			searchList();	
		});
	}
	...
	function save(id,func){
		...
		if(obj.academic_name == ""){
			warning('<?=getLanguage('trinh-do-hoc-van-khong-duoc-trong');?>'); 
			$("#academic_name").focus();
			return false;		
		}
		$('.loading').show();
	...
	function funcList(obj){
		$(".edit").each(function(e){
			$(this).click(function(){ 
				var academic_name = $(".academic_name").eq(e).text().trim();
				var id = $(this).attr('id');
				$("#id").val(id);	
