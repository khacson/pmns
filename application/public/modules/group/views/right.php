...
<div  style="height:355px; overflow-y:auto; float:left;width:380px; margin-left:-13px; border: 1px solid #d1dde2 !important; border-radius: 5px !important;">
...
<ul class="button-group pull-right" style="margin-right:0px; margin-top:6px;">
	<li id="saveright"><button class="button" style="height: 26px; padding: 2px 10px;"><?=getLanguage('sua');?></button></li>
</ul>
<style type="text/css">
