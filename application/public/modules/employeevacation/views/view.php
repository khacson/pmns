					...
					<tr class="row-searach">
						...
						<td>
							<div  id="click_fromdate" class="input-group date" data-provide="datepicker"  data-date-format="dd/mm/yyyy">
								<input id="fromdate" name="fromdate" type="text" value="<?=$datenow;?>" class="searchs form-control">
