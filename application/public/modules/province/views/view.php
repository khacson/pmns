...
<div class="box mtop10">
	<div class="box-header with-border">
	  <div class="brc"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('tinh-thanh-pho');?></div>
...
<script>
	...
	function funcList(obj){
		$(".edit").each(function(e){
			$(this).click(function(){ 
				var province_name = $(".province_name").eq(e).text().trim();
				var id = $(this).attr('id');
				$("#id").val(id);	
