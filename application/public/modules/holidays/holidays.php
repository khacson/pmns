...
class Holidays extends CI_Controller {
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns('hre_holidays');
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-nghi');
		$func =  getLanguage('them-moi').': '.$array['dateoff'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-nghi');
		$func =  getLanguage('sua').': '.$array['dateoff'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-nghi');
		$func =  getLanguage('xoa').': '.$findID->dateoff;
