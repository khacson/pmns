...
<div class="box mtop10">
	<div class="box-header with-border">
	  <div class="brc"><?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('ca-lam-viec');?></div>
			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th><?=getLanguage('ca-lam-viec');?></th>
						<th><?=getLanguage('dau-ca');?></th>
						<th><?=getLanguage('cuoi-giua-ca');?></th>
...
<script>
	...
	function save(id,func){
		...
		if(obj.shift_name == ""){
			warning('<?=getLanguage('ca-lam-viec-khong-duoc-trong');?>'); 
			$("#shift_name").focus();
			return false;		
		}
		$('.loading').show();
	...
	function funcList(obj){
		$(".edit").each(function(e){
			$(this).click(function(){ 
				var shift_name = $(".shift_name").eq(e).text().trim();
