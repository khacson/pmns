...
class Shift extends CI_Controller {
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_shift']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('ca-lam-viec');
		$func =  getLanguage('them-moi').': '.$array['shift_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('ca-lam-viec');
		$func =  getLanguage('sua').': '.$array['shift_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('ca-lam-viec');
		$func =  getLanguage('xoa').': '.$findID->shift_name;
