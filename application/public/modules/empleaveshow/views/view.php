			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th id="ord_ts.description"><?=getLanguage('ly-do-nghi')?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
			...
			<div id="gridView">
				<table id="group"  width="100%" cellspacing="0" border="1">
					...
					<tr class="row-searach">
						...
						<td>
							<div id="click_tomdate" class="input-group date" data-provide="datepicker"  data-date-format="dd/mm/yyyy">
...
<script>
	...
	function searchFunction(){
		$("#code,#fullname,#description").keyup(function() {
			searchList();	
		});
