			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th id="ord_r.otherdebt_money"><?=getLanguage('so-tien');?></th>
						<th id="ord_r.otherdebt_date"><?=getLanguage('ngay');?></th>
			...
			<div id="gridView">
				<table id="group"  width="100%" cellspacing="0" border="1">
					...
					<tr class="row-searach">
						...
						<td>
							<input type="text" name="otherdebt_money" id="otherdebt_money" class="searchs form-control " />
						</td>
						<td>
						...
						<td>
							<input type="text" name="otherdebt_content" id="otherdebt_content" class="searchs form-control " />
						</td>
						<td></td>
						<td></td>
					</tr>
	...
	function funcList(obj){
		$(".edit").each(function(e){
			$(this).click(function(){ 
				...
				var otherdebt_date  = $(".otherdebt_date").eq(e).text().trim();
				var id = $(this).attr('id');
				var departmentid = $(this).attr('departmentid');
				$("#id").val(id);	
				$("#reward_content").val(reward_content);
				$("#otherdebt_date").val(otherdebt_date);
