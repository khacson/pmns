...
class Endoffmonth extends CI_Controller {
    var $phonedetail;
	var $login;
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('ngay-chot-cong');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_endoffmonth']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-chot-cong');
		$func =  getLanguage('them-moi').': '.$array['monthyear'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-chot-cong');
		$func =  getLanguage('sua').': '.$array['monthyear'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('ngay-chot-cong');
		$func =  getLanguage('xoa').': '.$findID->monthyear;
