...
class Taxpersonal extends CI_Controller {
    var $phonedetail;
	var $login;
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('thue-thu-nhap-ca-nhan');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_taxpersonal']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('thue-thu-nhap-ca-nhan');
		$func =  getLanguage('them-moi').': '.$array['tax'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('thue-thu-nhap-ca-nhan');
		$func =  getLanguage('sua').': '.$array['tax'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('thue-thu-nhap-ca-nhan');
		$func =  getLanguage('xoa').': '.$findID->tax;
