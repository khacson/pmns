...
class Company extends CI_Controller {
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('cong-ty');
		$func =  getLanguage('them-moi').': '.$array['company_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('cong-ty');
		$func =  getLanguage('sua').': '.$array['company_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('cong-ty');
		$func =  getLanguage('xoa').': '.$findID->company_name;
