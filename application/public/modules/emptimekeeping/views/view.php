					...
					<tr class="row-searach">
						...
						<td>
							<div id="click_time_start" class="input-group date" data-provide="datepicker"  data-date-format="dd/mm/yyyy">
								<input value="<?=$time_start;?>" id="time_start" name="time_start" type="text" class="searchs form-control tab-event">
...
<script>
	...
	function refresh(){
		...
		$('#time_end').val('<?=$datenow;?>');
		$('#time_start').val('<?=$time_start;?>');
		$('#departmentid,#positionid,#group_work_id').multipleSelect('uncheckAll');
		csrfHash = $('#token').val();
		search = getSearchs();
	...
	function getSearchs() {
		...
		objReq.departmentid = getCombo('departmentid');
		objReq.positionid = getCombo('positionid');
		objReq.group_work_id = getCombo('group_work_id'); 
