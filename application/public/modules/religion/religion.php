...
class Religion extends CI_Controller {
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_religion']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('ton-giao');
		$func =  getLanguage('them-moi').': '.$array['religion_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('ton-giao');
		$func =  getLanguage('sua').': '.$array['religion_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('ton-giao');
		$func =  getLanguage('xoa').': '.$findID->religion_name;
