			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th id="ord_r.date_reward"><?=getLanguage('ngay-khen-thuong');?></th>
						<th id="ord_r.reward_content"><?=getLanguage('noi-dung-khen-thuong');?></th>
						<th id="ord_r.money"><?=getLanguage('tien-thuong');?></th>
						<th id="ord_r.isinsurrance"><?=getLanguage('dong-bao-hiem');?></th>
						<th id="ord_r.statusid"><?=getLanguage('tinh-trang');?></th>
						<th id="ord_r.ispay"><?=getLanguage('thanh-toan');?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
