...
class Position extends CI_Controller {
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_position']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('chuc-vu');
		$func =  getLanguage('them-moi').': '.$array['position_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('chuc-vu');
		$func =  getLanguage('sua').': '.$array['position_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('chuc-vu');
		$func =  getLanguage('xoa').': '.$findID->position_name;
