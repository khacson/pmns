...
class Criteriakpidepartment extends CI_Controller {
	var $login;
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('tieu-chuan-kpi');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns($tb['hre_criteriakpi_department']);
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('tieu-chuan-kpi');
		$func =  getLanguage('them-moi').': '.$array['kpi_name'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('tieu-chuan-kpi');
		$func =  getLanguage('sua').': '.$array['kpi_name'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('tieu-chuan-kpi');
		$func =  getLanguage('xoa').': '.$findID->kpi_name;
