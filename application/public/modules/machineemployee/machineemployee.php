...
class Machineemployee extends CI_Controller {
    var $phonedetail;
	var $login;
    ...
    function _view() {
		...
		#gegion add log
		$ctrol = getLanguage('nhan-vien-may-cham-com');
	...
	function form(){
		...
		if(empty($find->id)){
			$find = $this->base_model->getColumns('hre_machine_fingerprint');
		}
		$data = new stdClass();
        $result = new stdClass();
		$data->finds = $find;  
    ...
    function save() {
		...
		#region logfile
		$ctrol = getLanguage('nhan-vien-may-cham-com');
		$func =  getLanguage('them-moi').': '.$array['employee_code'];
		$this->base_model->addAcction($ctrol,$func,'','');	
		#end
	...
	function edit() {
		...
		#region logfile
		$ctrol = getLanguage('nhan-vien-may-cham-com');
		$func =  getLanguage('sua').': '.$array['employee_code'];
    ...
    function deletes() {
		...
		#region logfile
		$ctrol = getLanguage('nhan-vien-may-cham-com');
		$func =  getLanguage('xoa').': '.$findID->employee_code;
