	    ...
	    <div class="row">
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="fullname" placeholder="<?=getLanguage('nhap-ten-nhan-vien');?>" id="fullname" class="searchs form-control tab-event" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="employee_code" placeholder="<?=getLanguage('nhap-ma-nhan-vien');?>" id="employee_code" class="searchs form-control tab-event" />
					</div>
				</div>
			</div>
		</div>
			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th><?=getLanguage('ma-nhan-vien');?></th>
						<th><?=getLanguage('ten-nhan-vien');?></th>
						<th><?=getLanguage('password');?></th>
						<th><?=getLanguage('privilege');?></th>
						<th><?=getLanguage('enabled');?></th>
						<th><?=getLanguage('version');?></th>
						<th><?=getLanguage('Flag1');?></th>
						<th><?=getLanguage('TmpData1');?></th>
						<th><?=getLanguage('TmpLength1');?></th>
						<th><?=getLanguage('Flag2');?></th>
						<th><?=getLanguage('TmpData2');?></th>
						<th><?=getLanguage('TmpLength2');?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
...
<script>
	...
	function funcList(obj){
		$(".edit").each(function(e){
			$(this).click(function(){ 
				/*var employee_code = $(".employee_code").eq(e).text().trim();
